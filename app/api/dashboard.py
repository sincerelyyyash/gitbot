...
Provides dashboard endpoints for GitBot analytics and metrics.
"""
...
class DashboardAPI(BaseAPI):
    """
    Dashboard API component for analytics and metrics.
    ...
    def _setup_routes(self):
        ...
        # Dashboard Overview
        self.router.get("/overview", response_model=DashboardOverview)(
            self.get_dashboard_overview
        )
        
        # Repository Analytics
        self.router.get("/repositories", response_model=List[RepositoryStats])(
            self.get_repositories_stats
        )
        self.router.get("/repositories/{owner}/{repo}", response_model=RepositoryStats)(
            self.get_repository_stats
        )
        self.router.get("/repositories/{owner}/{repo}/pr-summaries")(
            self.get_repository_pr_summaries
        )
        
        # Activity and Timeline
        self.router.get("/activity/timeline", response_model=List[ActivityTimelineItem])(
            self.get_activity_timeline
        )
        self.router.get("/activity/recent", response_model=List[RecentAction])(
        ...
        self.router.get("/analytics/pr-summaries")(
            self.get_pr_summary_analytics
        )
        ...
        self.router.get("/export/actions")(
            self.export_actions
        )
    ...
    async def get_dashboard_overview(
        ...
        try:
            ...
            self.logger.exception("Error getting dashboard overview")
            raise HTTPException(
    ...
    async def get_repositories_stats(
        ...
        try:
            ...
            self.logger.exception("Error getting repositories stats")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_repository_stats(
        ...
        try:
            ...
            owner, repo = self.auth_manager.sanitize_repository_name(owner, repo)
            ...
            self.logger.exception(f"Error getting repository stats for {owner}/{repo}")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_repository_pr_summaries(
        ...
        try:
            ...
            self.logger.exception(f"Error getting PR summary stats for {owner}/{repo}")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_activity_timeline(
        ...
        try:
            ...
            if repo_full_name:
                repo_full_name = self.sanitize_string_input(repo_full_name)
            ...
            self.logger.exception("Error getting activity timeline")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_recent_actions(
        ...
        try:
            ...
            limit, _ = self.validate_pagination_params(limit)
            ...
            self.logger.exception("Error getting recent actions")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_pr_summary_analytics(
        ...
        try:
            ...
            self.logger.exception("Error getting PR summary analytics")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_analytics_summary(
        ...
        try:
            ...
            self.logger.exception("Error getting analytics summary")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def get_performance_metrics(
        ...
        try:
            ...
            self.logger.exception("Error getting performance metrics")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    async def export_actions(
        ...
        try:
            ...
            self.logger.exception("Error exporting actions")
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
